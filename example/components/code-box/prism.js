                    ...
                    for (const o in r) {
                        if (r.hasOwnProperty(o) && r[o]) {
                            ...
                            for (let u = 0; u < s.length; ++u) {
                                ...
                                for (
                                    let m = c.pattern || c, y = a.next, k = i;
                                    ...
                                    if (!(b instanceof W)) {
                                        ...
                                        if (h && y != t.tail.prev) {
                                            ...
                                            for (
                                                let E = y;
                                                E !== t.tail && (S < P || typeof E.value === 'string');
                                                E = E.next
                                            ) { x++, (S += E.value.length) }
                                        ...
                                        if (w) {
                                            ...
                                            const _ = new W(o, g ? M.tokenize(O, g) : O, v, O);
                                            (y = I(t, C, _)),
                                            N && I(t, y, N),
                                            x > 1 &&
                            e(n, t, r, y.prev, k, {
